...
while i < 12:                 # instagram only presents 12 comments at a time
    comment_list.append(ig_path.find_element_by_xpath('//*[@id="react-root"]/section/main/div/div[1]/article/div[3]/div[1]/ul/ul[1+'comment_count']/div/li/div/div/div[2]/span'))    # append the comment to a list or write to a csv file
    i += 1
    comment_count += 1
    if i == 12
